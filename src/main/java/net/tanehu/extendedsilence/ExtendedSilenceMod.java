 ...
 *
 */
package net.tanehu.extendedsilence;
...
import net.tanehu.extendedsilence.init.ExtendedSilenceModEnchantments;
import net.tanehu.extendedsilence.init.ExtendedSilenceModBlocks;
import net.tanehu.extendedsilence.init.ExtendedSilenceModBlockEntities;
...
@Mod("extended_silence")
public class ExtendedSilenceMod {
	public static final Logger LOGGER = LogManager.getLogger(ExtendedSilenceMod.class);
	public static final String MODID = "extended_silence";

	public ExtendedSilenceMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		ExtendedSilenceModBlocks.REGISTRY.register(bus);
		ExtendedSilenceModBlockEntities.REGISTRY.register(bus);
		ExtendedSilenceModItems.REGISTRY.register(bus);
		ExtendedSilenceModEntities.REGISTRY.register(bus);
		ExtendedSilenceModEnchantments.REGISTRY.register(bus);
		ExtendedSilenceModTabs.REGISTRY.register(bus);
